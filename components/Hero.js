...
export default function Hero() {
  return (
    <section className="relative w-full h-screen flex items-end pb-24 md:pb-18 overflow-hidden">
      ...
      <div className="relative z-10 w-full px-18 text-white ">
        <div className="max-w-3xl ">
          <h1 className="text-3xl md:text-3xl font-semibold leading-tight mb-6 font-space-grotesk">
            We’re a team of the best photography in Tirupati,
            <span className="block opacity-90">unveiling untold through art of photography.</span>
          </h1>
